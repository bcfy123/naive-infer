...
#ifndef NAIVE_INFER_INCLUDE_PARSER_RUNTIME_OPERAND_HPP_
#define NAIVE_INFER_INCLUDE_PARSER_RUNTIME_OPERAND_HPP_
#include <vector>
#include <string>
#include <memory>
...
#endif //NAIVE_INFER_INCLUDE_PARSER_RUNTIME_OPERAND_HPP_
